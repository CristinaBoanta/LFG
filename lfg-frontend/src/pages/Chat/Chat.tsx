...
export const Chat = (): JSX.Element => {
    ...
    return (
        <div className="flex flex-col h-screen max-h-[90vh] bg-gray-800 border border-gray-700">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-800/20 backdrop-blur-sm">
