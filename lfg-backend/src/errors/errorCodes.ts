...
export const ERROR_STATUS_CODES = {
  ...
  [AuthErrorCodes.USERNAME_ALREADY_EXISTS]: 409,
  [AuthErrorCodes.INVALID_USERNAME_FORMAT]: 400,
...
export const ERROR_MESSAGES = {
  ...
  [AuthErrorCodes.USERNAME_ALREADY_EXISTS]: "Username already in use",
  [AuthErrorCodes.INVALID_USERNAME_FORMAT]: "Invalid username format",
